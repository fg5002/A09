...
export const currData2 = writable(
  [
    {
      name: "Taxon",
      data: [{hun: "Holló", ltn: "Corvus corax", mon: "222222222222", id: 145}]
    },
    {
      name: "Attributes",
      data: [ {id: 6, nam: "hím", rep: "*h", val: "1"},
              {id: 14, nam: "nőstény", rep: "*n", val: "4"},
            ]
    },
    {
      name: "Notes",
    ...
    {
      name: "Media",
      data: [ {nam: "20230504-001.jpg", id: 1},
              {nam: "20230504-002.jpg", id: 2}
            ]
    },
    {
      name: "Observer",
      data: [ {nam: "Kiss Péter", id: 12},
              {nam: "Nagy Pál", id: 5}
            ]
    },
    {
      name: "Geo",
      data: [{nam: "Berkentúli erdő", id: 324}]
    },
    {
      name: "Date",
      data: {date: "2024-04-012"}
    },
    {
      name: "Id",
      data: {id: 12887}
